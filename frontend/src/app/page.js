...
const roles = [
  {
    ...
    route: "/orders",
    // Ảnh xe tải vận chuyển siêu thị
    image:
  ...
  },
  {
    ...
    route: "/manager",
    // Ảnh cảng/trung tâm điều hành logistics
    image:
...
export default function RolePickerPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f2f0ef] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      {/* Header Banner phong cách Editorial */}
      ...
      <div className="max-w-6xl w-full mx-auto mt-12 text-center">
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} ABC-Trans Smart Fleet Management.
